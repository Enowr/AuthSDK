...
2. 根据需求选择是否添加, 在 app module 的 build.gradle 中添加引用:  
    ```aidl
    dependencies {
        compile 'tech.jianyue.auth:auth:1.2.3'
        compile 'tech.jianyue.auth:auth_huawei:1.2.3'
        compile 'tech.jianyue.auth:auth_qq:1.2.3'
        compile 'tech.jianyue.auth:auth_weibo:1.2.3'
        compile 'tech.jianyue.auth:auth_weixin:1.2.3'
        compile 'tech.jianyue.auth:auth_yinlian:1.2.3'
        compile 'tech.jianyue.auth:auth_zhifubao:1.2.3'
    }
    ```
